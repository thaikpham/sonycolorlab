...
export const translations = {
    ...
    noDemoPhotos: { vi: "Bạn chưa đóng góp ảnh demo nào.", en: "You haven't contributed any demo photos yet." },
    uploadPhoto: { vi: "Tải ảnh lên", en: "Upload Photo" },
    saveAIGeneratedRecipe: { vi: "Lưu vào Lab của tôi", en: "Save to My Lab" },
    // New editable recipe translations
    recipeNameLabel: { vi: "Tên Công thức", en: "Recipe Name" },
    recipeDescriptionLabel: { vi: "Mô tả", en: "Description" },
    notesLabel: { vi: "Ghi chú cá nhân", en: "Personal Notes" },
    notesPlaceholder: { vi: "Viết ghi chú của bạn ở đây...", en: "Write your notes here..." },
    saveToDriveBtn: { vi: "Lưu vào Google Drive", en: "Save to Google Drive" },
    googleSignInRequired: { vi: "Vui lòng đăng nhập bằng Google để sử dụng tính năng này.", en: "Please sign in with Google to use this feature." },
    googleAuthExpired: { vi: "Phiên đăng nhập Google đã hết hạn. Vui lòng đăng xuất và đăng nhập lại.", en: "Google session expired. Please sign out and sign back in." },
    savingToDrive: { vi: "Đang lưu...", en: "Saving..." },
    driveSaveSuccess: { vi: "Đã lưu công thức vào Google Drive của bạn!", en: "Recipe saved to your Google Drive!" },
    driveSaveError: { vi: "Không thể lưu vào Google Drive.", en: "Could not save to Google Drive." },
    logInToContinue: { vi: "Vui lòng đăng nhập để tiếp tục.", en: "Please log in to continue." },
    // New Demo Photo Submission Translations
    submitYourPhoto: { vi: "Gửi ảnh của bạn", en: "Submit Your Photo" },
    submitDemoPhotoTitle: { vi: "Đóng góp Ảnh Demo", en: "Contribute a Demo Photo" },
    howToContributeTitle: { vi: "Hướng dẫn Đóng góp", en: "Contribution Guide" },
    howToContributeDescription: { vi: "Ảnh của bạn có thể được chọn để hiển thị trong thư viện chính! Hãy làm theo các bước sau:", en: "Your photo could be featured in the main gallery! Please follow these steps:" },
    contributeStep1: { vi: "Tải ảnh của bạn lên một dịch vụ chia sẻ (ví dụ: Google Photos, Flickr) và lấy link công khai.", en: "Upload your photo to a sharing service (e.g., Google Photos, Flickr) and get a public link." },
    contributeStep2: { vi: "Điền link ảnh và các thông tin được yêu cầu trong form.", en: "Fill out the photo link and required information in the form." },
    contributeStep3: { vi: "Ảnh sẽ được xét duyệt trước khi hiển thị công khai. Cảm ơn sự đóng góp của bạn!", en: "Photos will be reviewed before being displayed publicly. Thank you for your contribution!" },
    photoUrlLabel: { vi: "Link đến ảnh của bạn", en: "URL to your photo" },
    photoUrlHint: { vi: "Hãy đảm bảo link được chia sẻ công khai.", en: "Make sure the link is publicly accessible." },
    recipeUsedLabel: { vi: "Công thức màu đã sử dụng", en: "Color Recipe Used" },
    selectRecipePlaceholder: { vi: "Chọn một công thức...", en: "Select a recipe..." },
    captionLabel: { vi: "Tiêu đề (Caption)", en: "Caption" },
    descriptionLabel: { vi: "Mô tả ngắn", en: "Short Description" },
    submitBtn: { vi: "Gửi", en: "Submit" },
    submissionSuccess: { vi: "Gửi ảnh thành công! Cảm ơn bạn.", en: "Photo submitted successfully! Thank you." },
    submissionError: { vi: "Gửi ảnh thất bại, vui lòng thử lại.", en: "Submission failed, please try again." },
    mySubmissionsTitle: { vi: "Ảnh bạn đã đóng góp", en: "My Submissions" },
    // Auth error messages
