            ...
            <div class="p-4 bg-white/80 rounded-2xl border text-left space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" id="recipeName" class="w-full text-xl font-bold p-2 border-b-2" value="${escapeBackticks(generated.name)}">
                    </div>
                     <div>
                ...
                <div>
                    ...
                    <textarea id="recipeDescription" rows="2" class="w-full text-gray-600 mt-1 italic p-2 border-b-2">${escapeBackticks(generated.description)}</textarea>
                </div>
            </div>
